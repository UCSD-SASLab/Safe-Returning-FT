...
plot(Target_x+0.5,Target_y+0.5,'g*','lineWidth', 2)
hold on
plot(Obs_x+0.5,Obs_y+0.5,'rd','lineWidth', 2)

plot(Init_x+0.5,Init_x+0.5,'bo','lineWidth', 2)
...
%  j=j;
 ...
 h=plot(Optimal_path(:,1)+.5,Optimal_path(:,2)+.5);
else
 pause(1);
