...
%   data_filenames{1} = 'Q10D_Q3D_Rel_u_3_tenth.mat';
  data_filenames{1} = 'Q10D_Q3D_Rel_u_2_tenth.mat';
  data_filenames{2} = 'Q10D_Q3D_Rel_u_1_tenth.mat';
...
%   Mode{i}.derivZ = computeGradients(Mode{i}.sD_Z.grid,Mode{i}.dataZ);
    Mode{i}.derivX = Mode{i}.dataX0;
    Mode{i}.derivZ = Mode{i}.dataZ0;
